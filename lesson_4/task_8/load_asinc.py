import asyncio
import time
from model import aload_file_by_url, FileType
...
async def async_load(
    ...
    """
    Загружает и сохраняет на диск список urls с использованием асинхронности
    """
...
if __name__ == "__main__":
    ...
    asyncio.run(async_load(urls_img, file_type=FileType.IMAGE, target_dir="img"))
